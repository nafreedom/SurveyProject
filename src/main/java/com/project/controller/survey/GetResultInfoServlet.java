...
@WebServlet("/doGetResultInfo")
public class GetResultInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("doGetResultInfo : " + title + ", " + creatorId);
        ...
        try {
            ...
            jsonObject = survey.getResultInfo(surveyNum);
